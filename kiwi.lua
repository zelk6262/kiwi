...
function InterfaceManager:ImportSettings()
    pcall(function()
        if not DEBUG and getfenv().isfile and getfenv().readfile and getfenv().isfile("UISettings.kiwi") and getfenv().readfile("UISettings.kiwi") then
...
pcall(function()
    if not DEBUG and getfenv().isfile and getfenv().readfile and getfenv().isfile(string.format("%s.kiwi", game.GameId)) and getfenv().readfile(string.format("%s.kiwi", game.GameId)) and UISettings.AutoImport then
...
do
    local Window = Fluent:CreateWindow({
        Title = string.format("%s", string.format(MonthlyLabels[os.date("*t").month], "kiwi"), #Status > 0 and Status or ""),
        SubTitle = "",
    ...
    if getfenv().isfile and getfenv().readfile and getfenv().writefile and getfenv().delfile then
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                xpcall(function()
                    if getfenv().isfile(string.format("%s.kiwi", game.GameId)) and getfenv().readfile(string.format("%s.kiwi", game.GameId)) then
                        local ImportedConfiguration = HttpService:JSONDecode(getfenv().readfile(string.format("%s.kiwi", game.GameId)))
                        for Key, Value in next, ImportedConfiguration do
                        ...
                        Window:Dialog({
                            ...
                            Content = string.format("Configuration File %s.kiwi has been successfully loaded!", game.GameId),
                            Buttons = {
                                {
                                    Title = "Confirm"
                                }
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("An Error occurred when loading the Configuration File %s.kiwi", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                xpcall(function()
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("Configuration File %s.kiwi has been successfully overwritten!", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("An Error occurred when overwriting the Configuration File %s.kiwi", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                if getfenv().isfile(string.format("%s.kiwi", game.GameId)) then
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("Configuration File %s.kiwi has been successfully removed!", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
    ...
    if UISettings.ShowWarnings then
        ...
        elseif ShowWarning then
            Window:Dialog({
                Title = "Alert",
                Content = string.format("Expert Checks failed to load!", string.format(MonthlyLabels[os.date("*t").month], "kiwi")),
                Buttons = {
                    {
                        Title = "Confirm"
                    }
...
local OnTeleport; OnTeleport = Player.OnTeleport:Connect(function()
    if DEBUG or not Fluent or not getfenv().queue_on_teleport then
        ...
        getfenv().queue_on_teleport("getfenv().loadstring(game:HttpGet(\"https://raw.githubusercontent.com/kiwi/Open-Aimbot/master/source.lua\", true))()")
        OnTeleport:Disconnect()
    end
end)
